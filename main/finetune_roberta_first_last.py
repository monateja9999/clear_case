...
def load_data(filename):
    ...
    return df['input_text'], df['case_label']

# Tokenize cases
# def tokenize_cases(cases, labels, tokenizer, max_len=512):
#     input_ids = []
#     attention_masks = []
...
def main():
    ...
    outname = "saved_models/roberta_trained_test.pt"
    ...
    # Create dataloaders
    train_dataloader, val_dataloader = create_dataloaders(train_dataset, dev_dataset,batch_size)
